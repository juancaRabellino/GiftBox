        ...
        {fotos.map(function (foto, i) {
          return (
            <div className='loMasRegalado' style={{ width: '35vw' }} key={`img${i}`}>
              <div className="loMasRegaladoImagenResponsive" style={{ backgroundImage: `url('${foto.img}')`, height: '35vh', backgroundSize: 'cover', backgroundPosition: 'center', display: 'flex', alignItems: 'flex-end' }}>
              </div>
